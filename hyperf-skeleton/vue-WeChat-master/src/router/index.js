...
const routes = [{
    ...
    },
    {
        ...
        components: {
            ...
            "subPage": resolve => require(["../components/self/login.vue"], resolve)
        }
    },
    {
        path: '/register',
        components: { "default": resolve => require(["../components/self/register.vue"], resolve), "subPage": resolve => require(["../components/self/settings.vue"], resolve) }
    },
    {
